...
Part of this code is based on https://github.com/tinghuiz/SfMLearner/blob/master/utils.py,
published under MIT License.
We would like to thank T. Zhou and other authors for sharing their code
